     ...
     /* desenho das casas horizontais */
        for (int x=0; x<15; x++) {
        	for (int y=6; y <9; y++) {
        		...
        		if ( ((x == 13) & (y == 6)) | ((x ==1) & (y == 8)) ) //pretas
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.BLACK);
        		
        		else if ( ((y==7) & (x>0) & (x<6)))//vermelhas
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.RED);
        		
        		else if ( ((y==7) & (x>8) & (x<14)))//amarelas
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.YELLOW);
        		
        		else br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.WHITE);
        ...
        for (int x=6; x<9; x++) {
        	for (int y=0; y <15; y++) {
        		...
        		else if ( ((x==7) & (y>0) & (y<6)))//verdes
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.GREEN);
        		
        		else if ( ((x==7) & (y>8) & (y<14)))//azuis
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.BLUE);
        		
        		else
        			br = new Casa(x*boardWidth/15, y*boardHeight/15, boardWidth/15, boardHeight/15, Color.WHITE);
