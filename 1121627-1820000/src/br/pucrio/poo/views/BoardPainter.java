...
public class BoardPainter {
	...
	public void paintBoard(Graphics2D graphics) {
		...
		casas.add(new Casa(0*boardWidth/15,  1*boardWidth/15,  6*boardHeight/15, 7*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 0));
		casas.add(new Casa(1*boardWidth/15,  2*boardWidth/15,  6*boardHeight/15, 7*boardHeight/15, Color.RED,   boardWidth/15, boardHeight/15, 1));
		...
		casas.add(new Casa(6*boardWidth/15,  7*boardWidth/15,  0*boardHeight/15, 1*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 11));
		casas.add(new Casa(7*boardWidth/15,  8*boardWidth/15,  0*boardHeight/15, 1*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 12));
		casas.add(new Casa(8*boardWidth/15,  9*boardWidth/15,  0*boardHeight/15, 1*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 13));
		casas.add(new Casa(8*boardWidth/15,  9*boardWidth/15,  1*boardHeight/15, 2*boardHeight/15, Color.GREEN, boardWidth/15, boardHeight/15, 14));
		...
		casas.add(new Casa(1*boardWidth/15,  2*boardWidth/15,  8*boardHeight/15, 9*boardHeight/15, Color.BLACK, boardWidth/15, boardHeight/15, 49));
		casas.add(new Casa(0*boardWidth/15,  1*boardWidth/15,  8*boardHeight/15, 9*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 50));
		casas.add(new Casa(0*boardWidth/15,  1*boardWidth/15,  7*boardHeight/15, 8*boardHeight/15, Color.WHITE, boardWidth/15, boardHeight/15, 51));
	//finais vermelhas
		casas.add(new Casa(1*boardWidth/15,  2*boardWidth/15, 7*boardHeight/15, 8*boardHeight/15, Color.RED, boardWidth/15, boardHeight/15,52));
	...
	//finais verdes
		casas.add(new Casa(7*boardWidth/15,  8*boardWidth/15, 1*boardHeight/15, 2*boardHeight/15, Color.GREEN, boardWidth/15, boardHeight/15, 57));
		...
		//casas iniciais
		casas.add(new CasaInicial(1*boardWidth/15, 2*boardWidth/15, 1*boardHeight/15, 2*boardHeight/15, Color.RED, boardWidth/15, boardHeight/15, 72));
		casas.add(new CasaInicial(4*boardWidth/15, 5*boardWidth/15, 1*boardHeight/15, 2*boardHeight/15, Color.RED, boardWidth/15, boardHeight/15, 73));
		casas.add(new CasaInicial(1*boardWidth/15, 2*boardWidth/15, 4*boardHeight/15, 5*boardHeight/15, Color.RED, boardWidth/15, boardHeight/15, 74));
		...
		casas.add(new CasaInicial(10*boardWidth/15, 11*boardWidth/15, 1*boardHeight/15, 2*boardHeight/15, Color.GREEN, boardWidth/15, boardHeight/15, 76));
		casas.add(new CasaInicial(13*boardWidth/15, 14*boardWidth/15, 1*boardHeight/15, 2*boardHeight/15, Color.GREEN, boardWidth/15, boardHeight/15, 77));
		...
		casas.add(new CasaInicial(1*boardWidth/15, 2*boardWidth/15, 10*boardHeight/15, 11*boardHeight/15, Color.BLUE, boardWidth/15, boardHeight/15, 84));
		...
		casas.add(new CasaInicial(1*boardWidth/15, 2*boardWidth/15, 13*boardHeight/15, 14*boardHeight/15, Color.BLUE, boardWidth/15, boardHeight/15, 86));
